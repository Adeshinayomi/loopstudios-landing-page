...
export function Footer(){
    return(
        <footer className='bg-black mt-16 grid justify-center py-16 gap-10'>
            <div className='justify-self-center'>
                <img src={Logo} alt="logo" />
            </div>
            <ul className='text-white justify-self-center grid gap-3 justify-center'>
            ...
            <p className='text-Grey200 text-lg font-medium'>© 2021 Loopstudios. All rights reserved.</p>
        </footer>
    )
}